  ...
  render() {
    ...
    return (
      <BottomNavigation id='nav-bar' value={this.state.value} onChange={this.handleChange} >
        ...
        <BottomNavigationAction onClick={(e) => this.handleClick(e, '/login')} label="Search" value="search" icon={<SearchIcon />} />
        <BottomNavigationAction onClick={(e) => this.handleClick(e, '/photo/new')} label="Add" value="add" icon={<AddBoxIcon />} />
        <BottomNavigationAction onClick={(e) => this.handleClick(e, '/login')} label="Favorites" value="favorites" icon={<FavoriteIcon />} />
        <BottomNavigationAction onClick={(e) => this.handleClick(e, '/profile')} label="Person" value="person" icon={<PersonIcon />} />
      </BottomNavigation>
    )
  }
}
